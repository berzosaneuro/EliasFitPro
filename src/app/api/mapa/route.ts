...
export async function POST(request: Request) {
  ...
  const nivel = Object.values(dimensions as Record<string, number>).reduce((a, b) => a + b, 0) / 5
  ...
  const entry = {
    presencia: dimensions.presencia,
    calma: dimensions.calma,
    claridad: dimensions.claridad,
    energia: dimensions.energia,
    conexion: dimensions.conexion,
