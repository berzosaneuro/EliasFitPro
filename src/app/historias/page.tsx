...
const stories: Story[] = [
  ...
  },
  {
    ...
    story: 'Dirijo una empresa de 40 personas. Dormía 5 horas, vivía en modo reacción. Mi rendimiento bajaba y lo compensaba con más horas. Un círculo destructivo. NeuroConciencia me enseñó que 10 minutos de Flow State antes de trabajar me dan 3 horas extra de productividad real. Mi equipo nota la diferencia.',
  ...
  },
  {
    ...
    story: 'Llevaba 2 años sin dormir bien. Había probado melatonina, infusiones, terapia del sueño. El protocolo de sueño de NeuroConciencia (ritual nocturno + meditación Yoga Nidra + respiración 4-7-8) me cambió la vida en 3 semanas. Ahora duermo 7-8 horas de calidad.',
  ...
  },
  {
    ...
    story: 'Tenía ataques de pánico semanales. El modo SOS de NeuroConciencia fue mi salvavidas los primeros meses. La respiración 4-7-8 cortaba el ataque en 2 minutos. Con el tiempo, pasé de apagar fuegos a prevenir incendios. Hoy estoy preparándome para la certificación de Guía NeuroConciencia.',
      ...
      <section className="pb-6">
        <Container>
          <div className="grid grid-cols-3 gap-3">
            ...
            <div className="glass rounded-2xl p-4 text-center">
              <span className="text-amber-400 text-xl font-bold">{stories.length}</span>
