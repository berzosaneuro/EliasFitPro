...
export const metadata: Metadata = {
  title: 'NeuroConciencia for Teams — Bienestar corporativo',
...
const stats = [
  ...
  { value: '-28%', label: 'Absentismo', icon: TrendingDown, color: 'text-amber-400' },
        ...
        <Container>
          <div className="text-center max-w-2xl mx-auto">
            ...
            <p className="text-text-secondary text-lg animate-fade-in-up">
              El 76% de empleados reportan estrés crónico. NeuroConciencia lo reduce con neurociencia, no con pizza los viernes.
            </p>
          </div>
        </Container>
      </section>
