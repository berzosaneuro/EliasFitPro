...
export const metadata: Metadata = {
  title: 'NeuroConciencia Kids — Mindfulness para niños',
...
const features = [
  ...
  { title: 'Diario de emociones', desc: 'Stickers y colores para que los niños expresen cómo se sienten.', icon: Sun, color: 'bg-amber-500/15 text-amber-400' },
        ...
        <Container>
          <div className="text-center max-w-2xl mx-auto">
            <div className="inline-flex items-center gap-2 px-4 py-1.5 glass rounded-full mb-6">
              ...
              <span className="text-amber-400 text-sm font-medium">Para niños de 6-12 años</span>
            </div>
            <h1 className="font-heading text-4xl md:text-5xl font-bold text-white mb-4 animate-fade-in">
              NeuroConciencia<br /><span className="gradient-text">Kids</span>
            </h1>
        ...
        <Container>
          <FadeInSection>
            <div className="glass rounded-3xl p-8 text-center border border-accent-blue/20">
              ...
              <p className="text-text-secondary text-sm mb-2">NeuroConciencia Kids se lanza en primavera 2025.</p>
          ...
          <FadeInSection>
            <div className="max-w-lg mx-auto">
              <EmailCapture
                ...
                subtitle="Serás de los primeros en acceder a NeuroConciencia Kids."
