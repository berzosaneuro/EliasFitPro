...
const arModes = [
  ...
  { id: 'energy', icon: Eye, name: 'Campo de energia', desc: 'Visualizacion de aura y campo energetico', color: 'text-amber-400', bg: 'bg-amber-500/10', border: 'border-amber-500/30' },
