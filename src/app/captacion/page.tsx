              ...
              {[
                {
                  ...
                  desc: 'No meditación genérica. Cada ejercicio está basado en neuroplasticidad, con protocolos que rewire tu cerebro.',
                },
                {
        ...
        <Container>
          <FadeInSection>
            ...
            <div className="grid md:grid-cols-2 gap-3">
              ...
              <div className="glass rounded-2xl p-6 border border-yellow-500/20 relative">
                <div className="absolute -top-3 right-4 px-3 py-1 bg-yellow-500/20 text-yellow-400 text-xs font-semibold rounded-full flex items-center gap-1">
                ...
                <Link
                  href="/planes"
                  className="block text-center py-3 rounded-xl bg-yellow-500/20 text-yellow-400 font-semibold text-sm active:scale-95 transition-transform"
                >
