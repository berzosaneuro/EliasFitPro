...
const NIVELES = [
  ...
  { min: 4, max: 6, nombre: 'Observador', color: 'text-yellow-400', desc: 'Puedes observar sin reaccionar.' },
...
export default function MapaPage() {
  ...
  useEffect(() => {
    ...
    if (todayEntry) {
      setTodayValues(todayEntry.dimensions)
    }
  }, [])
              ...
              <div className="flex items-end gap-[3px] h-32">
                {last30.map((entry, i) => {
                  ...
                  const colorMap: Record<string, string> = {
                    ...
                    'text-yellow-400': 'bg-yellow-500/60',
