...
const bundles = [
  ...
  { name: 'Bundle: Libro + 3 meses Premium', price: '39,99', icon: Sparkles, color: 'text-amber-400', border: 'border-amber-500/30', best: true },
]
          ...
          <div className="grid md:grid-cols-3 gap-4 max-w-3xl mx-auto">
            {bundles.map((b, i) => (
              <FadeInSection key={b.name}>
                ...
                >
                  {b.best && (
                    <div className="absolute -top-3 left-1/2 -translate-x-1/2 px-3 py-0.5 bg-gradient-to-r from-amber-500 to-orange-500 text-white text-[10px] font-bold rounded-full whitespace-nowrap">
                      MEJOR VALOR
                    </div>
                  )}
                  <div className={`w-10 h-10 rounded-xl ${b.best ? 'bg-amber-500/10' : 'bg-white/5'} flex items-center justify-center mb-3`}>
          ...
          <FadeInSection>
            <div className="glass rounded-3xl p-6 border border-violet-500/10 max-w-2xl mx-auto">
              ...
              <p className="text-text-secondary text-sm leading-relaxed">
                ...
                el laboratorio y la consciencia. Creador del Método N.E.U.R.O. y la plataforma NeuroConciencia.
              </p>
            </div>
          </FadeInSection>
        </Container>
