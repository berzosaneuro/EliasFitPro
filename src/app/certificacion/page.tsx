...
export const metadata: Metadata = {
  title: 'Certificación Guía NeuroConciencia',
  description: 'Formación de 3 meses para convertirte en Guía certificado de NeuroConciencia. Neurociencia + meditación + facilitación.',
}
...
const benefits = [
  'Certificado oficial de Guía NeuroConciencia',
...
export default function CertificacionPage() {
  return (
    <div className="relative overflow-hidden">
      <div className="orb w-96 h-96 bg-amber-600 top-20 -right-20" />
        ...
        <Container>
          <div className="text-center max-w-2xl mx-auto">
            <div className="inline-flex items-center gap-2 px-4 py-1.5 glass rounded-full mb-6">
              ...
              <span className="text-amber-400 text-sm font-medium">Certificación profesional</span>
            </div>
            <h1 className="font-heading text-4xl md:text-5xl font-bold text-white mb-4 animate-fade-in">
              Conviértete en Guía<br /><span className="gradient-text">NeuroConciencia</span>
            </h1>
      ...
      <section className="pb-8">
        <Container>
          <FadeInSection>
            <div className="glass rounded-3xl p-8 text-center border border-amber-500/20">
              ...
              <button className="w-full max-w-sm mx-auto py-4 bg-gradient-to-r from-amber-500 to-orange-500 text-white rounded-2xl font-semibold active:scale-95 transition-transform">
                Reservar mi plaza
              </button>
